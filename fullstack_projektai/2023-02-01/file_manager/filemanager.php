...
<body>
    <div class="container py-4">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <!-- <td>
                            <i> <input type="checkbox" class="form-check-input" id="same-address">
                                <label class="form-check-label" for="save-info">Check</label>
                            </i>

                        </td> -->
                        <td>
                            <i class="red"> <input type="checkbox" class="form-check-input" id="same-address">   
        ...
        <?php } else { ?> 
            ...
            <h3>Create or Upload New File or Folder</h3>
